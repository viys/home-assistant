...
- ✅ ZHA 集成已配置完成
- ✅ Zigbee 网关已连接（如 SONOFF Zigbee 3.0 USB Dongle Plus）
...
3. 点击你的设备（如 SONOFF SNZB-03）
4. 查看设备信息：

```
设备信息：
- IEEE 地址: 00:12:4b:00:25:6a:bc:de
- 制造商: SONOFF
- 型号: SNZB-03
```
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        ...
        print("示例: python parse_ota.py SNZB-03_v1.0.5.ota")
        sys.exit(1)
...
```bash
python parse_ota.py config/zigpy_ota/SNZB-03_v1.0.5.ota
```
...
```
============================================================
OTA 文件信息：config/zigpy_ota/SNZB-03_v1.0.5.ota
============================================================
...
#### 示例 1：单个 Sonoff SNZB-03 设备

```json
[
  {
    "fileName": "SNZB-03_v1.0.5.ota",
    "fileVersion": 5,
    "fileSize": 204288,
    "manufacturerCode": 4742,
    "imageType": 8209,
    "url": "/config/zigpy_ota/SNZB-03_v1.0.5.ota",
    "modelId": "SNZB-03",
...
[
  ...
  {
    "fileName": "SNZB-02_v2.0.3.ota",
    "fileVersion": 203,
    "fileSize": 189440,
    "manufacturerCode": 4742,
    "imageType": 8208,
    "url": "/config/zigpy_ota/SNZB-02_v2.0.3.ota",
    "modelId": "SNZB-02",
    "manufacturerName": ["SONOFF"],
    "releaseNotes": "新增温湿度校准功能"
  },
  {
    "fileName": "SNZB-04_v3.1.0.ota",
    "fileVersion": 310,
    "fileSize": 195600,
    "manufacturerCode": 4742,
    "imageType": 8210,
    "url": "/config/zigpy_ota/SNZB-04_v3.1.0.ota",
    "modelId": "SNZB-04",
    "manufacturerName": ["SONOFF"],
...
| `manufacturerCode` | 整数 | **必需** | 制造商代码（十进制），Sonoff = 4742 |
...
# 输出示例：
# -rw-r--r-- 1 user user 199K Feb  4 10:30 SNZB-03_v1.0.5.ota
...
# 将所有 .ota 文件放到这个目录
# 例如：
cp SNZB-03_v1.0.5.ota config/zigpy_ota/
cp SNZB-02_v2.0.3.ota config/zigpy_ota/
```
...
zha:
  zigpy_config:
    ota:
      # 禁用默认的 Sonoff 官方源（因为要用自己的固件）
      disable_default_providers: [sonoff]
      extra_providers:
        # 保留其他厂商的官方更新
        - type: ikea
        - type: inovelli
...
[
  {
    "fileName": "SNZB-03_v1.0.5_stable.ota",
    "fileVersion": 5,
    "manufacturerCode": 4742,
    "imageType": 8209,
    "url": "/config/zigpy_ota/SNZB-03_v1.0.5_stable.ota",
    "modelId": "SNZB-03",
    "releaseNotes": "稳定版"
  },
  {
    "fileName": "SNZB-03_v1.0.6_beta.ota",
    "fileVersion": 6,
    "manufacturerCode": 4742,
    "imageType": 8209,
    "url": "/config/zigpy_ota/SNZB-03_v1.0.6_beta.ota",
    "modelId": "SNZB-03",
...
|----------|------------------|------------------|------|
| SNZB-03 (运动传感器) | 4742 (0x1286) | 8209 (0x2011) | 需从实际固件获取 |
| SNZB-02 (温湿度传感器) | 4742 (0x1286) | 8208 (0x2010) | 需从实际固件获取 |
| SNZB-04 (门窗传感器) | 4742 (0x1286) | 8210 (0x2012) | 需从实际固件获取 |
